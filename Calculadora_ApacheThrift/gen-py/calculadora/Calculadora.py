...
class divide_result(object):
    ...
    def __init__(self, success=None, div0=None,):
        self.success = success
        self.div0 = div0
        ...
        while True:
            ...
            if fid == 0:
                ...
                if ftype == TType.STRUCT:
                    self.div0 = DivideEntre0()
                    self.div0.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            oprot.writeDouble(self.success)
            oprot.writeFieldEnd()
        if self.div0 is not None:
            oprot.writeFieldBegin('div0', TType.STRUCT, 1)
            self.div0.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
divide_result.thrift_spec = (
    (0, TType.DOUBLE, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'div0', [DivideEntre0, None], None, ),  # 1
)
